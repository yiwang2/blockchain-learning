...
@Contract(
		name = "FabCar", 
        info = @Info(title = "FabCar contract", 
        ...
        contact = @Contact(email = "f.carr@example.com", name = "F Carr", url = "https://hyperledger.example.com")))
@Default
public class FabCar implements ContractInterface {
